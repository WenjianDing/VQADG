...
from vqadg_q_att_data import get_loader
from vqadg_q_eval import Trainer as Trainer1
...
class Trainer(TrainerBase):
    def __init__(self, args, train_loader=None, val_loader=None, test_loader=None, train=True):
        ...
        from vqadg_q_att_model import VLT5VQADG, VLBartVQADG
    ...
    def train(self):
        ...
        args = parse_args(
            parse=False,
            backbone='t5-base',
            load='D:/VL-T5/VL-T5/snap/vqadg/r/q_eval/BEST'
        )
        args.gpu = 0
