...
from vqadg_q_cts_total_data import get_loader
...
class Trainer(TrainerBase):
    def __init__(self, args, train_loader=None, val_loader=None, test_loader=None, train=True):
        ...
        from vqadg_q_cts_total_model import VLT5VQADG, VLBartVQADG
    ...
    def train(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            for step_i, batch in enumerate(self.train_loader):
                ...
                loss2 = results['cts loss1']
                loss3 = results['cts loss2']
                ...
                if self.verbose:
                    ...
                    desc_str += f' | LM {l1:4f}'
                    desc_str += f' | Text {l2:4f}'
                    desc_str += f' | Image {l3:4f}'
