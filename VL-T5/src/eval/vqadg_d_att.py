...
from vqadg_d_att_data import get_loader
from vqadg_d_eval import Trainer as Trainer1
...
class Trainer(TrainerBase):
    def __init__(self, args, train_loader=None, val_loader=None, test_loader=None, train=True):
        ...
        from vqadg_d_att_model import VLT5VQADG, VLBartVQADG
    ...
    def train(self):
        ...
        args = parse_args(
            parse=False,
            backbone='t5-base',
            load='D:/VL-T5/VL-T5/snap/vqadg/r/d_eval/BEST'
        )
        args.gpu = 0
        trainer = Trainer1(args,
                          train=False
                          )
        ...
        for epoch in range(self.args.epochs):
            ...
            for step_i, batch in enumerate(self.train_loader):
                ...
                if self.args.fp16 and _use_native_amp:
                    ...
                    if self.args.distributed:
                        results = self.model.module.train_step(batch, trainer)
                    else:
                        results = self.model.train_step(batch)
