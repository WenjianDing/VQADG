...
class VLT5VQADG(VLT5):
    ...
    def train_step(self, batch, trainer1):
        ...
        # [32, 9]
        # print('vis feat', vis_feats)
        # print('vis feat shape', vis_feats.shape)
        # [32, 36,2048]
        # print('vis pos', vis_pos)
        # print('vis pos shape', vis_pos.shape)
        # [32, 36, 4],这里的pos是坐标，不需要进行attention
        #如果使用分类模型
        ...
        #如果使用语言模型
            ...
            token_tensor = result['token_ids']
            a, b = token_tensor.size()
            if int(b) > 4:
                token_tensor = token_tensor[:, 4:]
            new_batch = {}
            new_batch['input_ids'] = token_tensor.to(device)
    ...
    #def evaluation_score(self, batch):
