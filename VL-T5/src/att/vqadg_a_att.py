...
from vqadg_a_att_data import get_loader
from vqadg_a_eval import Trainer as Trainer1
...
class Trainer(TrainerBase):
    def __init__(self, args, train_loader=None, val_loader=None, test_loader=None, train=True):
        ...
        from vqadg_a_att_model import VLT5VQADG, VLBartVQADG
    ...
    def train(self):
        ...
        args = parse_args(
            parse=False,
            backbone='t5-base',
            load='D:/VL-T5/VL-T5/snap/vqadg/r/a_eval/BEST'
        )
        args.gpu = 0
        ...
        for epoch in range(self.args.epochs):
            ...
            for step_i, batch in enumerate(self.train_loader):
                ...
                if self.args.fp16 and _use_native_amp:
                    ...
                    if self.args.distributed:
                        results = self.model.module.train_step(batch, trainer1)
                    else:
                        results = self.model.train_step(batch)
                ...
                if self.verbose:
                    ...
                    desc_str += f' | Loss1 {l1:4f}'
                    desc_str += f' | Loss2 {l2:4f}'
